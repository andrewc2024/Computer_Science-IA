...
// When users click on the button 'Shop Now', they are scrolled to the
// section with the featured textbooks and new textbooks
...
db.collection("textbooks")
  ...
  .then((t) => {
    ...
    // Featured textbooks are the highest rated textbooks
    textbooks.sort((a, b) => {
    ...
    // New arrivals are textbooks sorted by time of arrival
    textbooks.sort((a, b) => {
    ...
    // Display information similar to how it is done
    // in search.js and profile.js, with textbook cards
    // that expand to fullscreen with more detailed information
